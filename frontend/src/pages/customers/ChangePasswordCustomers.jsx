...
import { changePasswordCustomer } from '../../features/customers/auth/authSlice'
import Spinner from '../../components/assets/Spinner'
import BackButton from '../../components/assets/BackButton'

function ChangePasswordCustomers() {
  ...
  const onSubmit = (e) => {
    ...
    if (password.length < 8) {
      ...
      dispatch(changePasswordCustomer(customerData))
        .unwrap()
        .then((customer) => {
...
export default ChangePasswordCustomers
